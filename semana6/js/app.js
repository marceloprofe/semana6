...
// PASO 1
// -------
const textoBuscado = "not";

const resultados = productos.filter(producto => producto.nombre
    .toLowerCase()
...
// a minúsculas.
"Notebook Lenovo".toLowerCase() // "notebook lenovo"
"Notebook HP".toLowerCase() // "notebook hp"
"Notebook Asus".toLowerCase() // "notebook asus"
"Mouse Logitech".toLowerCase() // "mouse logitech"
"Monitor Samsung".toLowerCase() // "monitor samsung"
"Teclado Redragon".toLowerCase() // "teclado redragon"
"Monitor LG".toLowerCase() // "monitor lg"
"Auriculares HyperX".toLowerCase() // "auriculares hyperx"
//
// PASO 4
// -------
//
...
"notebook lenovo".includes("note") // true
"notebook hp".includes("note") // true
"notebook asus".includes("note") // true
"mouse logitech".includes("note") // false
"monitor samsung".includes("note") // false
"teclado redragon".includes("note") // false
"monitor lg".includes("note") // false
"auriculares hyperx".includes("note") // false
...
function buscarProductos() {
    ...
    const resultados = productos.filter(producto => producto.nombre.toLowerCase().includes(texto));
